...
if __name__ == '__main__':
    try:
        ...
        account_id = cred_json["forge_pdf_forge_account_id"]

        api_client = google_ads_authentication(cred_json)
        max_campaign_date_query = """SELECT MAX(Date)as new_date
                FROM [GoogleAds].[CampaignPerformance_V2] WHERE [CustomerId]='9599253890'"""
        ...
        max_ad_date_query = """SELECT MAX(Date)as new_date
                                       FROM [GoogleAds].[AdgroupPerformance_V2] WHERE [CustomerId]='9599253890'"""
        ...
        max_landing_date_query = """SELECT MAX(Date)as new_date
                        FROM [GoogleAds].[LandingPage_V2] WHERE [CustomerId]='9599253890'"""
        ...
        max_geo_date_query = """SELECT MAX(Date)as new_date
                                       FROM [GoogleAds].[GeoPerformance_V2] WHERE [CustomerId]='9599253890'"""
        ...
        max_campaign_bid_date_query = """SELECT MAX(Date)as new_date
                                         FROM [GoogleAds].[CampaignPerformance_V2Bid] WHERE [CustomerId]='9599253890'"""
        ...
        max_keyword_date_query = """SELECT MAX(Date)as new_date
                                            FROM [GoogleAds].[KeywordPerformanceReport_V2] WHERE [CustomerId]='9599253890'"""
        ...
        max_bidding_date_query = """SELECT MAX(Date)as new_date
                                                    FROM [GoogleAds].[BiddingStrategyReport_V2] WHERE [CustomerId]='9599253890'"""
        ...
        max_ad_bid_date_query = """SELECT MAX(Date)as new_date
                                       FROM [GoogleAds].[AdgroupPerformance_V2Bid] WHERE [CustomerId]='9599253890'"""
