...
from models.ga import SodaPDFAccount, PDFForgeAccount, InpixioAccount, PCHAccount
...
def main():
    try:
        ...
        soda = SodaPDFAccount()
        pdf = PDFForgeAccount()
        inpixio = InpixioAccount()
        pch = PCHAccount()
        accounts = [soda, pdf, inpixio, pch]
        ...
        for account in accounts:
            for ga_property in account.properties:
