...
if __name__ == '__main__':
    try:
        ...
        max_campaign_date_query = """SELECT MAX(Date)as new_date
                FROM [GoogleAds].[CampaignPerformance_V2] WHERE [CustomerId]='3380374272'"""
        ...
        max_ad_date_query = """SELECT MAX(Date)as new_date
                                       FROM [GoogleAds].[AdgroupPerformance_V2] WHERE [CustomerId]='3380374272'"""
        ...
        max_landing_date_query = """SELECT MAX(Date)as new_date
                        FROM [GoogleAds].[LandingPage_V2] WHERE [CustomerId]='3380374272'"""
        ...
        max_keyword_date_query = """SELECT MAX(Date)as new_date
                                      FROM [GoogleAds].[KeywordPerformanceReport_V2] WHERE [CustomerId]='3380374272'"""
        ...
        max_bidding_date_query = """SELECT MAX(Date)as new_date
                                      FROM [GoogleAds].[BiddingStrategyReport_V2] WHERE [CustomerId]='3380374272'"""
        ...
        max_ads_craft_ai_query = """SELECT MAX(Date)as new_date
                                              FROM [GoogleAds].[AdgroupPerformance_V2CraftAI] WHERE [CustomerId]='3380374272'"""
        ...
        ads_bid_craft_ai_df['CampaignBiddingStrategyType'] = ads_bid_craft_ai_df['CampaignBiddingStrategyType'].map(map_bidding_data)
        ...
        max_ads_craft_ai_conv_query = """SELECT MAX(Date)as new_date
                                    FROM [GoogleAds].[AdgroupPerformance_V2CraftAIConv] WHERE [CustomerId]='3380374272'"""
        ...
        max_campaign_budget_query = """SELECT MAX(Date)as new_date
                                            FROM [GoogleAds].[CampaignPerformance_V2Budget] WHERE [CustomerId]='3380374272'"""
        ...
        max_geo_date_query = """SELECT MAX(Date)as new_date
                               FROM [GoogleAds].[GeoPerformance_V2] WHERE [CustomerId]='3380374272'"""
        ...
        max_ad_bid_date_query = """SELECT MAX(Date)as new_date
                               FROM [GoogleAds].[AdgroupPerformance_V2Bid] WHERE [CustomerId]='3380374272'"""
        ...
        max_campaign_bid_date_query = """SELECT MAX(Date)as new_date
                                                       FROM [GoogleAds].[CampaignPerformance_V2Bid] WHERE [CustomerId]='3380374272'"""
