...
from utils.get_google_ads_report import get_campaign_data, get_ads_data, get_geo_performance_data, get_landing_Page_data,get_keyword_view_data,get_bidding_strategy_data,get_ads_with_bid_data,get_campaign_bidding_data,get_ads_bid_craft_AI_data,get_ads_bid_craft_ai_conv_data
...
if __name__ == '__main__':
    try:
        ...
        account_id = cred_json["pdf_expert_account_id"]

        api_client = google_ads_authentication(cred_json)
        max_campaign_date_query = """SELECT MAX(Date)as new_date
                FROM [GoogleAds].[CampaignPerformance_V2] WHERE [CustomerId]='5597498795'"""
        ...
        max_ad_date_query = """SELECT MAX(Date)as new_date
                                       FROM [GoogleAds].[AdgroupPerformance_V2] WHERE [CustomerId]='5597498795'"""
        ...
        max_landing_date_query = """SELECT MAX(Date)as new_date
                        FROM [GoogleAds].[LandingPage_V2] WHERE [CustomerId]='5597498795'"""
        ...
        max_keyword_date_query = """SELECT MAX(Date)as new_date
                                      FROM [GoogleAds].[KeywordPerformanceReport_V2] WHERE [CustomerId]='5597498795'"""
        ...
        max_bidding_date_query = """SELECT MAX(Date)as new_date
                                      FROM [GoogleAds].[BiddingStrategyReport_V2] WHERE [CustomerId]='5597498795'"""
        ...
        max_ads_craft_ai_query = """SELECT MAX(Date)as new_date
                                              FROM [GoogleAds].[AdgroupPerformance_V2CraftAI] WHERE [CustomerId]='5597498795'"""
        ...
        max_ads_craft_ai_conv_query = """SELECT MAX(Date)as new_date
                                    FROM [GoogleAds].[AdgroupPerformance_V2CraftAIConv] WHERE [CustomerId]='5597498795'"""
        ...
        max_geo_date_query = """SELECT MAX(Date)as new_date
                               FROM [GoogleAds].[GeoPerformance_V2] WHERE [CustomerId]='5597498795'"""
        ...
        max_ad_bid_date_query = """SELECT MAX(Date)as new_date
                               FROM [GoogleAds].[AdgroupPerformance_V2Bid] WHERE [CustomerId]='5597498795'"""
        ...
        max_campaign_bid_date_query = """SELECT MAX(Date)as new_date
                                                       FROM [GoogleAds].[CampaignPerformance_V2Bid] WHERE [CustomerId]='5597498795'"""
