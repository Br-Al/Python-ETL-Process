...
if __name__ == '__main__':
    try:
        ...
        max_campaign_date_query = """SELECT MAX(TimePeriod)as new_date
                FROM [BingAds].[CampaignPerformanceReport_V2] WHERE [AccountId] = '143003792'"""
        ...
        max_ad_date_query = """SELECT MAX(TimePeriod)as new_date
                        FROM [BingAds].[AdPerformanceReport_V2] WHERE [AccountId] = '143003792'"""
        ...
        max_geo_date_query = """SELECT MAX(TimePeriod)as new_date
                                FROM [BingAds].[GeographicPerformanceReport_V2] WHERE [AccountId] = '143003792'"""
        ...
        max_urli_date_query = """SELECT MAX(TimePeriod)as new_date
                                        FROM [BingAds].[DestinationUrlPerformanceReport_V2] WHERE [AccountId] = '143003792'"""
        ...
        max_keyword_date_query = """SELECT MAX(TimePeriod)as new_date
                                        FROM [BingAds].[KeywordPerformanceReport_V2] WHERE [AccountId] = '143003792'"""
