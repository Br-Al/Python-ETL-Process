...
if __name__ == '__main__':
    try:
        ...
        e_date = yesterday
        MY_GOOGLE_PATH = 'C:/google_forge_ads_cred.json'
        cred_json = get_api_config(MY_GOOGLE_PATH)
        account_id = cred_json["forge_pdf_architect_account_id"]

        api_client = google_ads_authentication(cred_json)
        max_campaign_date_query = """SELECT MAX(Date)as new_date
                FROM [GoogleAds].[CampaignPerformance_V2] WHERE [CustomerId]='9516123033'"""
        ...
        max_ad_date_query = """SELECT MAX(Date)as new_date
                                       FROM [GoogleAds].[AdgroupPerformance_V2] WHERE [CustomerId]='9516123033'"""
        ...
        max_landing_date_query = """SELECT MAX(Date)as new_date
                        FROM [GoogleAds].[LandingPage_V2] WHERE [CustomerId]='9516123033'"""
        ...
        max_geo_date_query = """SELECT MAX(Date)as new_date
                                       FROM [GoogleAds].[GeoPerformance_V2] WHERE [CustomerId]='9516123033'"""
        ...
        max_campaign_bid_date_query = """SELECT MAX(Date)as new_date
                                         FROM [GoogleAds].[CampaignPerformance_V2Bid] WHERE [CustomerId]='9516123033'"""
        ...
        max_keyword_date_query = """SELECT MAX(Date)as new_date
                                            FROM [GoogleAds].[KeywordPerformanceReport_V2] WHERE [CustomerId]='9516123033'"""
        ...
        max_bidding_date_query = """SELECT MAX(Date)as new_date
                                                    FROM [GoogleAds].[BiddingStrategyReport_V2] WHERE [CustomerId]='9516123033'"""
        ...
        max_ad_bid_date_query = """SELECT MAX(Date)as new_date
                                       FROM [GoogleAds].[AdgroupPerformance_V2Bid] WHERE [CustomerId]='9516123033'"""
        ...
        ad_bid_start_date = get_max_date(max_ads_bid_date)
        ads_bid_df = get_ads_with_bid_data(api_client, account_id, ad_bid_start_date, e_date)
