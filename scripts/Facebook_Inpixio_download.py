...
if __name__ == '__main__':
    try:
        ...
        access_token = cred_json["inpixio_access_token"]
        app_id = cred_json["inpixio_app_id"]
        app_secret = cred_json["inpixio_app_secret"]
        account_id = cred_json["inpixio_account_id"]
        camapign_type_json = get_api_config(MY_FCB_CAMPAIGN_PATH)
        max_campaign_date_query = """SELECT MAX(date_stop)as new_date
                        FROM [Facebook].[AdInsights_V2] WHERE [account_id]= '10154815791482142'"""
